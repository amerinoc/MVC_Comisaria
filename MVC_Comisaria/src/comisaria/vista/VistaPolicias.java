 ...
 * @author usuario
 */
public class VistaPolicias extends javax.swing.JFrame {

    /**
     * Creates new form VistaPolicias
     */
    public VistaPolicias() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaPolicias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaPolicias().setVisible(true);
            }
        });
    }
